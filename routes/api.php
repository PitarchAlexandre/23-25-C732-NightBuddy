...
// Appelle le controleur qui montre la liste des utilisateurs
Route::get('/evenements', [App\Http\Controllers\UtilisateurController::class, 'index']);
// Appelle le controleur qui montre l'utilisateur mis en paramètre
Route::get('/evenements/{id}', [App\Http\Controllers\UtilisateurController::class, 'show']);
// Appelle le controleur qui effacera l'utilisateur mis en paramètre
Route::delete('/evenements/{id}', [App\Http\Controllers\UtilisateurController::class, 'destroy']);
// Appelle le controleur qui mettra à jour l'utilisateur mis en paramètre
Route::put('/evenements/{id}', [App\Http\Controllers\UtilisateurController::class, 'update']);
// Appelle le controleur qui ajoutera un nouvel utilisateur
Route::post('/evenements', [App\Http\Controllers\UtilisateurController::class, 'store']);
